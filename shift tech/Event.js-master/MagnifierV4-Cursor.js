...
var Magnifier = function (evt, options) {
    ...
    var gOptions = options || {},
        ...
        createLens = function (thumb, idx) {
			//console.log("New lense");
            var lens = document.createElement('div');

            lens.id = idx + '-lens';
            lens.className = 'magnifier-loader';
			lens.style.backgroundColor = 'black';

            thumb.parentNode.appendChild(lens);
			
			//console.log("@@@@");
			//curLens.appendChild(RedDot);
			//curLens.style.backgroundColor = "black";
			//curLarge.style.backgroundColor = "black";
        ...
        updateLensOnLoad = function (idx, thumb, large, largeWrapper) {
            ...
            if (data[idx].status === 1) {
				...
				//console.log("L - data[idx].largeW: " + data[idx].largeW);
				//console.log("L - data[idx].largeH: " + data[idx].largeH);
				
				//console.log("LE - data[idx].lensW: " + data[idx].lensW);
				//console.log("LE - data[idx].lensH: " + data[idx].lensH);
        ...
        getMousePos = function () {
			...
			else if(((150 < xPos && xPos < 300) && (0 < yPos && yPos < 150)))
			{
			    ...
			    // var RedDot = document.createElement('img');
				// RedDot.setAttribute("src", "curs.png");
				// RedDot.setAttribute("height", "10");
				// RedDot.setAttribute("width", "10");
